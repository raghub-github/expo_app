...
VALUES
  ...
  ('CUSTOMER_PAYMENT_FAILED',      'payment',     'customer', 'push', 'Payment not completed', 'Your payment for GatiMitra order #{{orderShortId}} was not completed. Any amount if debited from UPI will get refunded within 4-7 days.', '/checkout', 'high', '{"orderId":"string","orderShortId":"string","amount":"number","reason":"string"}'::jsonb),
