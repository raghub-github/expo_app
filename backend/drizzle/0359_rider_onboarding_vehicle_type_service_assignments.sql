-- Per onboarding vehicle type (bicycle, bike, auto_rickshaw, …) → dispatch service assignment.
-- Dispatch engine matches rider_vehicles.vehicle_type via maps_to_vehicle_type.
...
-- Seed from category-level defaults × vehicles in each category.
