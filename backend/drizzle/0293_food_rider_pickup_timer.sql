-- Pickup window timer (3 min) after merchant marks ready + rider at store.
-- Finalize pickup_wait_seconds when ready is marked (not on pickup OTP).
-- Migration: 0293_food_rider_pickup_timer
