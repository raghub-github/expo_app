-- =============================================================================
-- Add EVERY column used by merchant-menu API on merchant_menu_items in one go.
-- Run this once to stop "column X does not exist" errors (item_id, item_description,
-- item_image_url, has_customizations, preparation_time_minutes, approval_status, etc.).
