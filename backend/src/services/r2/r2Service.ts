...
/**
 * Cheap existence probe (HEAD, no body download). Used by the image-derivative
 * cache to decide "serve cached derivative" vs "generate it". Returns false on
 * NoSuchKey/404; rethrows only unexpected transport errors.
 */
