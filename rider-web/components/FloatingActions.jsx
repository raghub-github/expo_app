...
/** Same official Instagram the rider app links to. */
              ...
              <div className="p-4">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    <div className="w-8 h-8 rounded-full bg-gradient-to-r from-green-500/30 to-emerald-500/30 border border-green-500/50 flex items-center justify-center">
                      <MessageSquare className="w-4 h-4 text-green-400" />
                    </div>
                    <div>
                      <h3 className="text-base font-bold text-white">Join Our Groups</h3>
                      <p className="text-[10px] text-slate-500">WhatsApp · Telegram · Instagram</p>
                    </div>
                  </div>
                  <button
                    onClick={() => setIsGroupsOpen(false)}
                ...
                <p className="text-xs text-slate-400 mb-3">
                  Stay updated with offers, service updates, rider opportunities & exclusive deals.
                </p>
                ...
                <div className="space-y-2">
                  <a
                    ...
                    className="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-slate-800/80 hover:bg-slate-800 border border-slate-700 hover:border-green-500/50 transition-all group"
                  >
                    <div className="w-9 h-9 rounded-full bg-green-600 flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-semibold text-sm text-white">WhatsApp Channel</p>
                      <p className="text-[11px] text-slate-400 truncate">Official updates from GatiMitra</p>
                    </div>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-slate-800/80 hover:bg-slate-800 border border-slate-700 hover:border-blue-500/50 transition-all group"
                  >
                    <div className="w-9 h-9 rounded-full bg-blue-600 flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform">
                      <svg className="w-4.5 h-4.5 text-white" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[11px] text-slate-400 truncate">Offers, updates & community</p>
                    </div>
                    <ExternalLink className="w-3.5 h-3.5 text-slate-500 flex-shrink-0" />
                  </a>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-slate-800/80 hover:bg-slate-800 border border-slate-700 hover:border-pink-500/50 transition-all group"
                  >
                    <div className="w-9 h-9 rounded-full bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform">
                      <svg className="w-4.5 h-4.5 text-white" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[11px] text-slate-400 truncate">@gatimitra_on_demand</p>
                    </div>
                    <ExternalLink className="w-3.5 h-3.5 text-slate-500 flex-shrink-0" />
                  </a>
                </div>
