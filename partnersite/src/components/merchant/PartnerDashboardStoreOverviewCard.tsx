...
function MetricBoxSkeleton() {
  return (
    <div className={`${PARTNER_DASHBOARD_METRIC_BOX_SKELETON_CLASS} h-[48px] px-2 py-1.5`}>
    ...
    <div className={PARTNER_DASHBOARD_TOP_CARD_CLASS}>
      ...
      <div className="border-t border-slate-200/80 pt-2 shrink-0">
        <div className="mb-1.5 flex min-w-0 flex-nowrap items-center gap-2">
          ...
          <div className="flex min-w-0 flex-nowrap items-baseline gap-x-2 overflow-hidden">
            <h3 className="shrink-0 whitespace-nowrap text-[10px] font-semibold uppercase tracking-[0.14em] text-slate-500">
              Wallet &amp; earnings
            </h3>
            <p className="min-w-0 truncate whitespace-nowrap text-[10px] text-slate-400">
        ...
        {showWalletSkeleton ? (
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-1.5">
            ...
            <div className={PARTNER_DASHBOARD_METRIC_BOX_CLASS}>
              ...
              <p className="mt-0.5 text-sm font-bold tabular-nums text-orange-600">
            ...
            <div className={PARTNER_DASHBOARD_METRIC_BOX_CLASS}>
              ...
              <p className="mt-0.5 text-sm font-bold tabular-nums text-violet-600">
