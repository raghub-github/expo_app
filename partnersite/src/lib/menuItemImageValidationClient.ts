/**
 * Browser-side checks for menu item images (matches server rules).
 * Kept in sync with dashboard `src/lib/menuItemImageValidationClient.ts`.
 */
...
/** Center-crop to square, scale side to [MIN, MAX], JPEG under max bytes. */
