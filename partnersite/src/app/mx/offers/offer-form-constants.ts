/** Offer Engine V3 — wizard step definitions for Partner Site drawer */
...
/** First-screen promo presets shown to the partner before the form. */
...
/** Recommended percentage offer presets for the Conditions step. */
export const RECOMMENDED_PERCENTAGE_OFFERS = [
  { id: 'flat-30-149', discount: 30, maxDiscount: null, mov: 149, label: 'Flat 30% OFF' },
...
/** Recommended BOGO presets for the Conditions step. */
...
export type OfferPublishMode = 'draft' | 'publish';

export type OfferPreviewPricing = {
  mrp: number;
  sellingPrice: number;
