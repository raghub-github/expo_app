...
const nextConfig: NextConfig = {
  ...
  transpilePackages: ["@gatimitra/contracts", "@gatimitra/rider-availability", "@gatimitra/slab-pricing", "@gatimitra/bill-print", "@gatimitra/print-utils", "@gatimitra/kot-print", "geist"],
