...
export default async function FoodCustomersPage() {
  await requireDashboardAccess("CUSTOMER_FOOD");

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900">Food Customers</h1>
