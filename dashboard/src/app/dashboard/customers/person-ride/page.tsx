...
function PersonRideCustomersPageContent() {
  ...
  const { data, isLoading, error } = useCustomersQuery({
    ...
    orderType: "person_ride", // Always filter by person_ride orders
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-6">
          <div className="flex flex-col items-center justify-center py-12 space-y-4">
            ...
            <div className="text-center space-y-2">
              <h2 className="text-xl font-semibold text-gray-900">Search for Person Ride Customer</h2>
              <p className="text-sm text-gray-600 max-w-md">
                Please use the search bar in the header to search for a person ride customer by ID, name, or phone number.
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-6">
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-semibold text-gray-900">Person Ride Customers</h1>
          </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-yellow-700 mt-1">
                    No person ride customers match your search query. Please try a different search term.
                  </p>
                </div>
              </div>
            </div>
...
export default function PersonRideCustomersPage() {
  return (
    <Suspense fallback={<div className="p-6">Loading...</div>}>
      <PersonRideCustomersPageContent />
    </Suspense>
  );
}
