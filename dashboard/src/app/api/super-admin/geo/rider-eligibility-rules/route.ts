...
const ruleBodySchema = z.object({
  ...
  evProofRequirement: docReqSchema.optional(),
  ownershipProofRequirement: docReqSchema.optional(),
  commercialProofRequirement: docReqSchema.optional(),
...
export async function POST(req: NextRequest) {
  ...
  try {
    const rule = await insertRiderEligibilityRule({
      ...
      evProofRequirement: d.evProofRequirement ?? "exempt",
      ownershipProofRequirement: d.ownershipProofRequirement ?? "exempt",
      commercialProofRequirement: d.commercialProofRequirement ?? "exempt",
