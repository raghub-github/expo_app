...
const patchSchema = z.object({
  ...
  evProofRequirement: z.enum(["required", "optional", "exempt"]).optional(),
  ownershipProofRequirement: z.enum(["required", "optional", "exempt"]).optional(),
  commercialProofRequirement: z.enum(["required", "optional", "exempt"]).optional(),
...
export async function PATCH(req: NextRequest, ctx: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const merged = {
      ...
      evProofRequirement: p.evProofRequirement ?? current.evProofRequirement,
      ownershipProofRequirement: p.ownershipProofRequirement ?? current.ownershipProofRequirement,
      commercialProofRequirement: p.commercialProofRequirement ?? current.commercialProofRequirement,
