...
import { insertDeliverySlab, listDeliverySlabs } from "@/lib/db/operations/billing-reference";
...
export async function GET() {
  ...
  try {
    const slabs = await listDeliverySlabs();
...
export async function POST(req: NextRequest) {
  ...
  try {
    const slab = await insertDeliverySlab(parsed.data);
