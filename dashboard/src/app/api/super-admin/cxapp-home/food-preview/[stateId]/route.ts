...
export async function GET(request: NextRequest, ctx: RouteCtx) {
  ...
  try {
    ...
    const payload: FoodHomePreviewPayload = {
      ...
      classicUnder250Enabled: layoutConfig.classicUnder250.enabled,
      classicUnder250MaxPrice: layoutConfig.classicUnder250.maxPrice,
      classicUnder250Title: layoutConfig.classicUnder250.title,
      classicUnder250FilterLabel: layoutConfig.classicUnder250.filterLabel,
      classicUnder250TabImageUrl: layoutConfig.classicUnder250.tabImageUrl,
      classicUnder250HeroImageUrl: layoutConfig.classicUnder250.heroImageUrl,
