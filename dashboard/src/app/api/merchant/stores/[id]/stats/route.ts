/**
 * GET /api/merchant/stores/[id]/stats
 * Returns order stats for the store (for Store overview KPIs).
 */
...
export async function GET(
  ...
  try {
    ...
    // TODO: load from orders_food when wired
    ...
    console.error("[GET /api/merchant/stores/[id]/stats]", e);
