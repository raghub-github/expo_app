...
export type DiscoveryCtaTile = {
  ...
  /** Inner-page hero when this tile opens Deals At. Stored on the JSON tile — no extra column. */
  heroImageUrl: string | null;
  /** Max item price for this Deals At inner page. NULL uses layout fallback. */
