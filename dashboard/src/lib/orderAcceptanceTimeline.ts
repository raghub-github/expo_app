...
export type AcceptanceTimelineInput = {
  ...
  /** Food ready-by (merchant prep commitment); falls back to delivery ETA when omitted. */
  expectedByAt?: string | null;
};

export async function appendAcceptanceTimeline(input: AcceptanceTimelineInput): Promise<void> {
