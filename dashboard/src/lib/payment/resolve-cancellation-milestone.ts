...
/**
 * Maps live order state → payment_cancellation_rules lookup keys.
 * Pre-pickup: CREATED, ACCEPTED, PREPARING, READY_FOR_PICKUP (not yet out for delivery).
 * Post-pickup: OUT_FOR_DELIVERY.
 * After delivered: CANCELLED_AFTER_DELIVERED.
 */
