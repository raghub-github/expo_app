  ...
  return (
    <div className={shellClassName}>
      <div className={heroSpacingClassName}>
        ...
        >
          Clear guidelines on payments, refunds, and reversals for onboarding fees, subscriptions, and
          other charges.
        </p>
      ...
      <div className={summaryClassName}>
        ...
        <div>
          <h2 className={compact ? "font-semibold text-amber-900 text-sm" : "font-semibold text-amber-900 text-sm sm:text-base"}>
            In short
          </h2>
          <p className={compact ? "text-amber-800 text-xs sm:text-sm mt-1 leading-relaxed" : "text-amber-800 text-xs sm:text-sm mt-1 leading-relaxed"}>
            Payments are <strong>non-refundable</strong> once processed. Refunds or reversals may be
            considered only for duplicate charges, service failures, or erroneous debits, at
            GatiMitra&apos;s discretion and after verification.
          </p>
        </div>
      </div>
      ...
      <div className={sectionStackClassName}>
        <section className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
          <div className={cardHeaderClassName}>
            ...
            <h2 className={compact ? "text-base font-bold text-slate-900" : "text-lg font-bold text-slate-900"}>
              General policy
            </h2>
          </div>
          <div className={`${cardBodyClassName} prose prose-slate prose-sm max-w-none`}>
            ...
            <p className="text-slate-700 leading-relaxed mt-4">
              By completing a payment, you acknowledge that you have read and accepted the applicable
              terms and this refund policy. We recommend reviewing your plan and amount before
              confirming payment.
            </p>
          </div>
        </section>
        ...
        <section className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
          ...
          <div className={cardBodyClassName}>
            <p className={compact ? "text-slate-700 text-xs sm:text-sm leading-relaxed mb-3" : "text-slate-700 text-sm leading-relaxed mb-4"}>
              GatiMitra may, at its sole discretion and subject to verification, consider a refund or
              reversal only in the following circumstances:
            </p>
            <ul className={compact ? "space-y-3" : "space-y-4"}>
              <li className="flex gap-3">
                ...
                <div>
                  <h3 className={compact ? "font-semibold text-sm text-slate-900" : "font-semibold text-slate-900"}>
                    Duplicate payment
                  </h3>
                  <p className={compact ? "text-slate-600 text-xs sm:text-sm mt-0.5 leading-relaxed" : "text-slate-600 text-sm mt-0.5"}>
                    The same payment was charged more than once due to a technical or processing error
                    (e.g. double click, gateway retry). Proof of duplicate debit may be required.
                  </p>
                </div>
              </li>
              <li className="flex gap-3">
                ...
                <div>
                  ...
                  <p className={compact ? "text-slate-600 text-xs sm:text-sm mt-0.5 leading-relaxed" : "text-slate-600 text-sm mt-0.5"}>
                    Payment was taken but the corresponding service (e.g. plan activation, onboarding
                    completion, feature access) was not provided or could not be completed due to a
                    platform or operational failure on GatiMitra&apos;s side.
                  </p>
                </div>
              </li>
              <li className="flex gap-3">
                ...
                <div>
                  ...
                  <p className={compact ? "text-slate-600 text-xs sm:text-sm mt-0.5 leading-relaxed" : "text-slate-600 text-sm mt-0.5"}>
                    The amount debited was incorrect, or the charge was applied in error (wrong plan,
                    wrong store, or similar). Documentation may be required for verification.
                  </p>
                </div>
              </li>
            </ul>
            ...
            >
              ...
              case-by-case basis. Reversals may be credited to your wallet or refunded to the original
              payment method, depending on the situation and our policy at the time.
            </p>
          </div>
        </section>
        ...
        <section className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
          ...
          <div className={cardBodyClassName}>
            <p className={compact ? "text-slate-700 text-xs sm:text-sm leading-relaxed" : "text-slate-700 text-sm leading-relaxed"}>
              ...
              <strong>5–10 business days</strong>. The time taken for the amount to reflect in your bank
              account or wallet may vary depending on your bank or payment provider. We are not
        ...
        <section className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
          ...
          <div className={cardBodyClassName}>
            ...
            >
              ...
              <li>
                <strong>Transaction details</strong> (date, amount, payment reference or order ID if any)
              </li>
              <li>
                Clear <strong>reason</strong> for the request (e.g. duplicate charge, service not received)
              </li>
              <li>
                Any <strong>screenshots or proof</strong> (e.g. bank statement showing duplicate debit)
              </li>
            </ul>
            ...
            <p className={compact ? "text-slate-500 text-[11px] sm:text-xs mt-3 leading-relaxed" : "text-slate-500 text-xs mt-4"}>
              We aim to respond to refund requests within 2–3 business days. Approval and processing time
              may vary based on the nature of the request and verification required.
            </p>
          </div>
        </section>
        ...
        >
          ...
          <div>
            ...
            <p className={compact ? "text-slate-600 text-xs sm:text-sm mt-1 leading-relaxed" : "text-slate-600 text-sm mt-1"}>
              For any questions about payments, subscriptions, or this refund policy, reach out to{" "}
              <a href="mailto:support@gatimitra.com" className="text-orange-600 hover:underline font-medium">
                support@gatimitra.com
              </a>
      ...
      <p className={compact ? "text-center text-[11px] text-slate-500 mt-6 pb-4" : "text-center text-xs text-slate-500 mt-10 pb-8"}>
        This policy forms part of your agreement with GatiMitra. We may update it from time to time; the
