...
function IllustrationReady() {
  return (
    <svg viewBox="0 0 280 200" className="w-full max-w-[280px] h-auto" aria-hidden>
      <ellipse cx="140" cy="188" rx="100" ry="8" className="fill-slate-200/80" />
      <path d="M95 52 L185 52 L195 168 L85 168 Z" className="fill-amber-100 stroke-amber-300/80" strokeWidth="2" />
      ...
      <text x="140" y="108" textAnchor="middle" className="fill-white font-bold" style={{ fontSize: '11px', fontFamily: 'system-ui, sans-serif' }}>
        Gati
      </text>
      <text x="140" y="124" textAnchor="middle" className="fill-amber-100 font-bold" style={{ fontSize: '11px', fontFamily: 'system-ui, sans-serif' }}>
        Mitra
      </text>
...
function IllustrationPickedUp() {
  return (
    <svg viewBox="0 0 280 200" className="w-full max-w-[280px] h-auto" aria-hidden>
      ...
      <text x="150" y="128" textAnchor="middle" className="fill-white font-bold" style={{ fontSize: '9px', fontFamily: 'system-ui, sans-serif' }}>
        Gati
      </text>
      <text x="150" y="138" textAnchor="middle" className="fill-amber-100 font-bold" style={{ fontSize: '8px', fontFamily: 'system-ui, sans-serif' }}>
        Mitra
      </text>
