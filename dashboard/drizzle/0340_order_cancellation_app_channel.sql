-- Web vs App cancellation catalogs + optional service_type (food / person_ride / parcel).
-- Web rows keep channel = 'web' (dashboard order cancel/refund). App rows power rider/merchant mobile apps.
...
-- Rider app defaults (mirrors legacy hardcoded bottom sheet)
...
-- Seed penalty rule rows for app-channel RIDER reasons (Financial Rule Engine).
