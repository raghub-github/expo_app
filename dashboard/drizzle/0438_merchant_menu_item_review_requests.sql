-- =============================================================================
-- 0438_merchant_menu_item_review_requests.sql
-- Field-level merchant menu ADD/EDIT/DELETE review workflow.
-- Production-safe: IF NOT EXISTS / ADD VALUE IF NOT EXISTS. No data mutation of
-- merchant_menu_items. Legacy merchant_menu_item_change_requests left intact.
-- =============================================================================
...
CREATE TABLE IF NOT EXISTS merchant_menu_item_review_requests (
  ...
  client_ip TEXT,
  device_info TEXT,
  -- Full proposed item for ADD only (variants/addons/images refs included).
  add_payload JSONB,
...
-- One pending EDIT or DELETE per menu item
