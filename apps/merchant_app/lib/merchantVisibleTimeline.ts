...
export function orderRecordToTimelineOrder(o: OrderRecord): MerchantTimelineOrder {
  ...
  return {
    ...
    prepared_at: o.preparedAt,
    dispatched_at: o.dispatchedAt,
    delivered_at: o.deliveredAt ?? null,
    cancelled_at: o.cancelledAt,
    rejected_reason: o.rejectedReason,
    accepted_by_label: o.acceptedByLabel,
    cancelled_by_label: o.cancelledByLabel,
    rider_picked_up_at: o.riderPickedUpAt,
    handed_over_to_rider_at: o.handedOverToRiderAt,
