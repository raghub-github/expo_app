...
const s = StyleSheet.create({
  ...
  tabRow: { flexDirection: "row", backgroundColor: "#EFEFEF", borderRadius: 10, padding: 4 },
  ...
  chipActive: { backgroundColor: GatiMitraMerchant.navy, borderColor: GatiMitraMerchant.navy },
