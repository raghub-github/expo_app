...
**Version:** 2.0 (supersedes the 13 May 2026 PDF Privacy Policy)
...
This Policy applies to the GatiMitra customer mobile app, gatimitra.com, and every service we provide. It is supplemented by the [DPDPA Compliance Notice](./dpdpa-compliance-notice.md), [Permissions Rationale](./permissions-rationale.md), [Cookie & Tracking Policy](./cookie-tracking-policy.md), and [Data Deletion Policy](./data-deletion-policy.md).
...
See [Data Deletion Policy](./data-deletion-policy.md) for delete-flow details.
...
- `Profile → Settings → Privacy` (in-app, all rights available).
- privacy@gatimitra.com (email).
...
Per DPDPA §9, processing of personal data of children (below 18) requires verifiable parental consent. We do not behaviourally profile minors. See [Children's Privacy & Use Policy](./children-privacy-policy.md).
...
See [Grievance Redressal Mechanism](./grievance-redressal-mechanism.md). Acknowledgement instantly, first response 48 hours, resolution within 15 days. Escalation to the Grievance Appellate Committee (https://gac.gov.in) available after 30 days.

## 11. Cookies & tracking

See [Cookie & Tracking Policy](./cookie-tracking-policy.md).
