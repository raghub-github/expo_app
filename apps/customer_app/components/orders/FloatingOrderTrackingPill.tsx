...
import { View, TouchableOpacity, StyleSheet, Pressable, Image as RNImage } from "react-native";
...
import { getFloatingOrderStatusText, shouldShowFloatingOrderEta } from "@/lib/customer-order-status-display";
...
export function FloatingOrderTrackingPill({
  ...
  const showEta = shouldShowFloatingOrderEta(order.status, order.etaMinutes, order.serviceType);
