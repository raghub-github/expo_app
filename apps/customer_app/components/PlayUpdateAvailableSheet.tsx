/**
 * Play-style “Update available” bottom sheet — brand-colored (not Play blue).
 * Shown when Google Play reports a newer store version for THIS app.
 */
import {
  Image,
  Modal,
...
export type PlayUpdateAvailableSheetProps = {
  ...
  /** Optional subtitle under the name, e.g. current version. */
