...
export function mapboxRapidoRouteScript(): string {
  return `
      var endpointMarkers = [];
      ...
      function addRouteLayers() {
        ...
        map.addLayer({
          ...
          paint: {
            ...
            'line-width': ['interpolate', ['linear'], ['zoom'], 11, 7, 14, 10, 16, 12, 18, 14],
            'line-opacity': 1
          }
        });
        map.addLayer({
          ...
          paint: {
            ...
            'line-width': ['interpolate', ['linear'], ['zoom'], 11, 4.5, 14, 6.5, 16, 8, 18, 9.5],
            'line-opacity': 1
          }
        });
      }
