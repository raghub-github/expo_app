...
export default function PermissionRequestScreen() {
  ...
  const steps: PermissionStep[] = React.useMemo(() => {
    return [
      ...
      },
      {
        ...
        microText: "This permission allows the app to show important alerts even when other apps are open.",
        icon: "📱",
  ...
  useEffect(() => {
    const checkLocation = async () => {
      if (steps[currentStep]?.key === "location" || steps[currentStep]?.key === "location_services") {
        ...
        try {
          ...
          if (step.key === "location" || step.key === "location_services") {
            ...
            if (locationStatus.enabled) {
              // Location is enabled - close blocking modal and proceed
