...
export default function MerchantHelpTicket({ pageContext, className = "" }: MerchantHelpTicketProps) {
    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-[2200] flex items-center justify-center p-4">
          <div className="absolute inset-0 z-[2200] bg-black/50" onClick={() => setOpen(false)} />
